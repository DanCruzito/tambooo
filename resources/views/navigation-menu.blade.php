    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex">
                ...
                <a href="/welcome"
                class="flex flex-col items-center justify-center order-last md:order-first px-6 md:px-4 bg-opacity-25 text-gray-700 cursor-pointer font-semibold h-full">
                ...
                <!-- Logo -->
          {{--  <div class="flex-shrink-0 flex items-center h-10 w-30">
                    <a href="/">
...
--}}
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{route('admin.comprobante.index')}}" :active="request()->routeIs('admin.categories.*')">
                        Comprobantes
                    </x-jet-nav-link>
                    @endcan
                    ...
                    <x-jet-nav-link href="{{route('admin.promociones.index')}}" :active="request()->routeIs('crud_noticias.index')">
                        Promociones
                      </x-jet-nav-link>
                                         
                      <x-jet-nav-link href="{{route('admin.noticias.index')}}" :active="request()->routeIs('crud_promocion.index')">
                          Noticias
                      </x-jet-nav-link>
                    @endcan
                </div>
