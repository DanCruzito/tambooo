                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap  text-sm font-medium">
                            <a href="#" class="text-indigo-600 hover:text-indigo-900" wire:click="edit({{$item}})">
                                Editar
                            </a>
                            <a href="#" class="text-red-600 hover:text-indigo-900" wire:click="$emit('deletePromocion',{{ $item->id }})">
                                Eliminar
                            </a>
                        </td>
